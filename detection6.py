...
for idx, video_file in enumerate(os.listdir(video_directory)):
    ...
    hand_ratios.append([left_hand_ratio, right_hand_ratio])

    print(f"Processed video {idx + 1}: {video_file}")

# Convert list to numpy array and print the result matrix
hand_ratios_matrix = np.array(hand_ratios)
print("Hand Ratios Matrix:")
print(hand_ratios_matrix)